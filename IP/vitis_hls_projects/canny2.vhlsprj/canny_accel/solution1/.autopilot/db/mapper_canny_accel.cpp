...
extern "C" void canny_accel(long long*, long long*, int, int, int, int, int, int);
extern "C" void apatb_canny_accel_hw(volatile void * __xlx_apatb_param_img_inp, volatile void * __xlx_apatb_param_img_out, int __xlx_apatb_param_rows, int __xlx_apatb_param_cols, int __xlx_apatb_param_low_threshold, int __xlx_apatb_param_high_threshold) {
  ...
  // DUT call
  canny_accel(__xlx_img_inp__input_buffer, __xlx_img_out__input_buffer, __xlx_offset_byte_param_img_inp, __xlx_offset_byte_param_img_out, __xlx_apatb_param_rows, __xlx_apatb_param_cols, __xlx_apatb_param_low_threshold, __xlx_apatb_param_high_threshold);
