set moduleName Block_ZN2xf2cv3MatILi0ELi1080ELi1920ELi1ELi2EEC2Eii_exit11_proc40
set isTopModule 0
...
set C_modelName {Block__ZN2xf2cv3MatILi0ELi1080ELi1920ELi1ELi2EEC2Eii.exit11_proc40}
...
set C_modelArgMapList {[ 
	{ "Name" : "cols", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_mat_cols_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "high_threshold_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ low_threshold sc_in sc_lv 32 signal 4 } 
	{ high_threshold sc_in sc_lv 32 signal 5 } 
	{ in_mat_rows_out_din sc_out sc_lv 32 signal 6 } 
	{ in_mat_rows_out_full_n sc_in sc_logic 1 signal 6 } 
	{ in_mat_rows_out_write sc_out sc_logic 1 signal 6 } 
	{ in_mat_cols_out_din sc_out sc_lv 32 signal 7 } 
	{ in_mat_cols_out_full_n sc_in sc_logic 1 signal 7 } 
	{ in_mat_cols_out_write sc_out sc_logic 1 signal 7 } 
	{ dst_mat_rows_out_din sc_out sc_lv 32 signal 8 } 
	{ dst_mat_rows_out_full_n sc_in sc_logic 1 signal 8 } 
	{ dst_mat_rows_out_write sc_out sc_logic 1 signal 8 } 
	{ dst_mat_cols_out_din sc_out sc_lv 11 signal 9 } 
	{ dst_mat_cols_out_full_n sc_in sc_logic 1 signal 9 } 
	{ dst_mat_cols_out_write sc_out sc_logic 1 signal 9 } 
	{ img_inp_out_din sc_out sc_lv 64 signal 10 } 
	{ img_inp_out_full_n sc_in sc_logic 1 signal 10 } 
	{ img_inp_out_write sc_out sc_logic 1 signal 10 } 
	{ img_out_out_din sc_out sc_lv 64 signal 11 } 
	{ img_out_out_full_n sc_in sc_logic 1 signal 11 } 
	{ img_out_out_write sc_out sc_logic 1 signal 11 } 
	{ low_threshold_out_din sc_out sc_lv 32 signal 12 } 
	{ low_threshold_out_full_n sc_in sc_logic 1 signal 12 } 
	{ low_threshold_out_write sc_out sc_logic 1 signal 12 } 
	{ high_threshold_out_din sc_out sc_lv 32 signal 13 } 
	{ high_threshold_out_full_n sc_in sc_logic 1 signal 13 } 
	{ high_threshold_out_write sc_out sc_logic 1 signal 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_mat_cols_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "dst_mat_cols_out", "role": "din" }} , 
 	...
 	{ "name": "high_threshold_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "high_threshold_out", "role": "din" }} , 
 	{ "name": "high_threshold_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "high_threshold_out", "role": "full_n" }} , 
 	{ "name": "high_threshold_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "high_threshold_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "low_threshold_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "low_threshold_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "high_threshold_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	dst_mat_cols_out { ap_fifo {  { dst_mat_cols_out_din fifo_data 1 11 }  { dst_mat_cols_out_full_n fifo_status 0 1 }  { dst_mat_cols_out_write fifo_update 1 1 } } }
	...
	high_threshold_out { ap_fifo {  { high_threshold_out_din fifo_data 1 32 }  { high_threshold_out_full_n fifo_status 0 1 }  { high_threshold_out_write fifo_update 1 1 } } }
}
