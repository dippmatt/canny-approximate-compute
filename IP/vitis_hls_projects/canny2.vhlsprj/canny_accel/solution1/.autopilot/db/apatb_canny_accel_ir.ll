; ModuleID = '/home/soc/Documents/canny-approximate-compute_git/IP/vitis_hls_projects/canny2.vhlsprj/canny_accel/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_canny_accel_ir(%struct.ap_uint* %img_inp, %struct.ap_uint* %img_out, i32 %rows, i32 %cols, i32 %low_threshold, i32 %high_threshold) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_canny_accel_hw(%struct.ap_uint* %img_inp_copy1, %struct.ap_uint* %img_out_copy2, i32 %rows, i32 %cols, i32 %low_threshold, i32 %high_threshold)
...
declare void @apatb_canny_accel_hw(%struct.ap_uint*, %struct.ap_uint*, i32, i32, i32, i32)

define void @canny_accel_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, i32, i32, i32, i32) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint* null, %struct.ap_uint* %1)
  call void @canny_accel_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1, i32 %2, i32 %3, i32 %4, i32 %5)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint* null, %struct.ap_uint* %1)
  ret void
}

declare void @canny_accel_hw_stub(%struct.ap_uint*, %struct.ap_uint*, i32, i32, i32, i32)
