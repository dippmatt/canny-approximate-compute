set moduleName xFCannyKernel_0_8_0_1080_1920_0_12_1_32_1_20_1920_2_5760_3_false_Block_ZN2xf2cv3MatILi0ELi1080ELi1920ELi1ELi2EEC2Eii_exit15_proc
set isTopModule 0
...
set C_modelName {xFCannyKernel<0, 8, 0, 1080, 1920, 0, 12, 1, 32, 1, 20, 1920, 2, 5760, 3, false>_Block__ZN2xf2cv3MatILi0ELi1080ELi1920ELi1ELi2EEC2Eii.exit15_proc}
...
set portList { 
	...
	{ img_width_dout sc_in sc_lv 11 signal 0 } 
	{ img_width_empty_n sc_in sc_logic 1 signal 0 } 
	{ img_width_read sc_out sc_logic 1 signal 0 } 
	{ img_height_dout sc_in sc_lv 11 signal 1 } 
	{ img_height_empty_n sc_in sc_logic 1 signal 1 } 
	{ img_height_read sc_out sc_logic 1 signal 1 } 
	{ imgwidth_out_din sc_out sc_lv 11 signal 2 } 
	{ imgwidth_out_full_n sc_in sc_logic 1 signal 2 } 
	{ imgwidth_out_write sc_out sc_logic 1 signal 2 } 
	{ height_out_din sc_out sc_lv 11 signal 3 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "imgwidth_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "imgwidth_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "height_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
