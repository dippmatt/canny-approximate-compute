; ModuleID = '/home/soc/Documents/canny-approximate-compute/IP/vitis_hls_projects/grayscaler.vhlsprj/grayscaler/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_grayscale_accel2_ir(%struct.ap_uint* %img_inp, %struct.ap_uint* %img_out, i32 %rows, i32 %cols) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_grayscale_accel2_hw(%struct.ap_uint* %img_inp_copy1, %struct.ap_uint* %img_out_copy2, i32 %rows, i32 %cols)
...
declare void @apatb_grayscale_accel2_hw(%struct.ap_uint*, %struct.ap_uint*, i32, i32)

define void @grayscale_accel2_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, i32, i32) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint* null, %struct.ap_uint* %1)
  call void @grayscale_accel2_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1, i32 %2, i32 %3)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint* null, %struct.ap_uint* %1)
  ret void
}

declare void @grayscale_accel2_hw_stub(%struct.ap_uint*, %struct.ap_uint*, i32, i32)
