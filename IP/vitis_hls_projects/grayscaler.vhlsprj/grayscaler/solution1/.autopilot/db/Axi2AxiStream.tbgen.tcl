...
set C_modelArgList {
	...
	{ addrbound_V_read int 21 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "addrbound_V_read", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ addrbound_V_read sc_in sc_lv 21 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "addrbound_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "addrbound_V_read", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "din", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "din_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "addrbound_V_read", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "1"}]}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "777610"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "777610"}
]}
...
set Spec2ImplPortList { 
	...
	addrbound_V_read { ap_none {  { addrbound_V_read in_data 0 21 } } }
}
