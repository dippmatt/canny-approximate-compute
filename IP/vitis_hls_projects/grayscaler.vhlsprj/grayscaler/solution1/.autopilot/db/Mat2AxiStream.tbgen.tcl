...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "5", "6"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "last_blk_pxl_width11_U0"}],
		"OutputProcess" : [
			{"ID" : "2", "Name" : "MatStream2AxiStream_U0"}],
		"Port" : [
			{"Name" : "dst_mat_419", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "MatStream2AxiStream_U0", "Port" : "dst_mat_419"}]},
			...
			{"Name" : "rows", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "last_blk_pxl_width11_U0", "Port" : "rows"}]},
			{"Name" : "cols", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "last_blk_pxl_width11_U0", "Port" : "cols"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.last_blk_pxl_width11_U0", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.MatStream2AxiStream_U0.mul_32ns_32ns_64_2_1_U99", "Parent" : "2"},
