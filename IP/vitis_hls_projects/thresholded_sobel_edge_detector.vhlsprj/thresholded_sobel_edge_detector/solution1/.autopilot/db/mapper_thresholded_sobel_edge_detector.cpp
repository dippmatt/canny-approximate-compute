...
extern "C" void thresholded_sobel_edge_detector(long long*, long long*, int, int, int, int, short);
extern "C" void apatb_thresholded_sobel_edge_detector_hw(volatile void * __xlx_apatb_param_img_inp, volatile void * __xlx_apatb_param_img_out, int __xlx_apatb_param_rows, int __xlx_apatb_param_cols, short __xlx_apatb_param_thresh) {
  ...
  // DUT call
  thresholded_sobel_edge_detector(__xlx_img_inp__input_buffer, __xlx_img_out__input_buffer, __xlx_offset_byte_param_img_inp, __xlx_offset_byte_param_img_out, __xlx_apatb_param_rows, __xlx_apatb_param_cols, __xlx_apatb_param_thresh);
