; ModuleID = '/home/soc/Documents/canny-approximate-compute_git_new_ip/IP/vitis_hls_projects/thresholded_sobel_edge_detector.vhlsprj/thresholded_sobel_edge_detector/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_thresholded_sobel_edge_detector_ir(%struct.ap_uint* %img_inp, %struct.ap_uint* %img_out, i32 %rows, i32 %cols, i16 %thresh) local_unnamed_addr #0 {
entry:
  %img_inp_copy1 = alloca %struct.ap_uint, align 512
  %img_out_copy2 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %img_inp, %struct.ap_uint* nonnull align 512 %img_inp_copy1, %struct.ap_uint* %img_out, %struct.ap_uint* nonnull align 512 %img_out_copy2)
  call void @apatb_thresholded_sobel_edge_detector_hw(%struct.ap_uint* %img_inp_copy1, %struct.ap_uint* %img_out_copy2, i32 %rows, i32 %cols, i16 %thresh)
  call fastcc void @copy_out(%struct.ap_uint* %img_inp, %struct.ap_uint* nonnull align 512 %img_inp_copy1, %struct.ap_uint* %img_out, %struct.ap_uint* nonnull align 512 %img_out_copy2)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_thresholded_sobel_edge_detector_hw(%struct.ap_uint*, %struct.ap_uint*, i32, i32, i16)

define void @thresholded_sobel_edge_detector_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, i32, i32, i16) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint* null, %struct.ap_uint* %1)
  call void @thresholded_sobel_edge_detector_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1, i32 %2, i32 %3, i16 %4)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint* null, %struct.ap_uint* %1)
  ret void
}

declare void @thresholded_sobel_edge_detector_hw_stub(%struct.ap_uint*, %struct.ap_uint*, i32, i32, i16)
