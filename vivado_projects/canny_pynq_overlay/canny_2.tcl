...
#
# canny_2.tcl: Tcl script for re-creating project 'canny_2'
#
# Generated by Vivado on Mon Feb 26 05:45:13 PST 2024
...
#
# 1. This project restoration tcl script (canny_2.tcl) that was generated.
#
...
set orig_proj_dir "[file normalize "$origin_dir/canny_2"]"
...
proc cr_bd_design_1 { parentCell } {
  ...
  xilinx.com:hls:thresholded_sobel_edge_detector:1.0\
  "
  ...
  # Create instance: thresholded_sobel_ed_0, and set properties
  set thresholded_sobel_ed_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:thresholded_sobel_edge_detector:1.0 thresholded_sobel_ed_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins thresholded_sobel_ed_0/s_axi_control]
  connect_bd_intf_net -intf_net thresholded_sobel_ed_0_m_axi_gmem1 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins thresholded_sobel_ed_0/m_axi_gmem1]
  connect_bd_intf_net -intf_net thresholded_sobel_ed_0_m_axi_gmem2 [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins thresholded_sobel_ed_0/m_axi_gmem2]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins thresholded_sobel_ed_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins thresholded_sobel_ed_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs thresholded_sobel_ed_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces thresholded_sobel_ed_0/Data_m_axi_gmem1] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces thresholded_sobel_ed_0/Data_m_axi_gmem2] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.878244",
   "Default View_TopLeft":"0,-173",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1870 -y 180 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1870 -y 200 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 4 -x 1240 -y 220 -defaultsOSRD
...
preplace inst thresholded_sobel_ed_0 -pg 1 -lvl 3 -x 890 -y 150 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 170 390 10 710 70 1080 380 1390 340 1830
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 360 NJ 360 NJ 360 1070J 390 NJ 390 1840
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 3 400 250 710 230 1090
preplace netloc processing_system7_0_DDR 1 5 1 NJ 180
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 410 370 NJ 370 NJ 370 NJ 370 1850
preplace netloc axi_interconnect_0_M00_AXI 1 4 1 N 220
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 200
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 130
preplace netloc thresholded_sobel_ed_0_m_axi_gmem1 1 3 1 N 130
preplace netloc thresholded_sobel_ed_0_m_axi_gmem2 1 3 1 N 150
levelinfo -pg 1 0 210 560 890 1240 1610 1870
pagesize -pg 1 -db -bbox -sgen 0 0 1990 560
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/canny_2/canny_2.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
